...
<template>
  <div class="relative rounded-lg mx-auto max-w-[800px] bg-[#f3f3f3] p-[25px] pt-[24px] pb-[57px]">
    ...
    <div
      class="aspect-5/3 w-full bg-gray-[#f8f8f8] rounded-sm overflow-hidden inset-shadow-[0_5px_70px_rgba(0,0,0,0.25)]"
    >
      <img
        ref="screenRef"
        :src="props.imageSrc"
